...
let orderTotals = orders.map(element=>element["price"]*(1+element["tax"]))// Code here
...
let bobsTotal = purchases.reduce(function(total,element){
  if(element['owner']==="Bob"){return total+element['price']}return total},0)//Code Here
